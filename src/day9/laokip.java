...
public final class laokip {

    private static final String[] SCALE_LA = {"ລ້ານ", "ສິບ", "ຮ້ອຍ", "ພັນ", "ໝື່ນ", "ແສນ", ""};
    private static final String[] DIGIT_LA = {"ສູນ", "ໜຶ່ງ", "ສອງ", "ສາມ", "ສີ່", "ຫ້າ", "ຫົກ", "ເຈັດ", "ແປດ", "ເກົ່າ"};
    private static final String[] SYMBOLS_LA = {"ລົບ", "ກີບ", "", "ເສດກີບ", "ຊາວ", "ເອັດ", ",", " ", "LAK"};
    ...
    public String getText(double amount) {
        ...
        this.valueText = this.valueText.replace("ຊາວສິບ", "ຊາວ");
    ...
    public String getText(String amount) {
        //ບໍ່ຕ້ອງການເຄື່ອງໝາຍຈຸດ, ບໍ່ຕ້ອງການຊ໋ອງຫວ່າງ, ບໍ່ຕ້ອງການຕົວໜັງສີ ກີບ, ບໍ່ຕ້ອງການສັນຍາລັກ LAK
