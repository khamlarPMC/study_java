...
public class test extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
         ...
         String f_name = capitalize(fname.getText().toLowerCase());
         String l_name =lname.getText().toUpperCase();
         String fulname= f_name.concat(" ".concat(l_name));
         JOptionPane.showMessageDialog(rootPane, fulname  );
